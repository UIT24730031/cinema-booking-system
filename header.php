  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo ($current_page == 'movies_events.php') ? 'active' : ''; ?>"><a href="movies_events.php">Phim Đang Chiếu</a></li>
        <li class="<?php echo ($current_page == 'schedule.php') ? 'active' : ''; ?>"><a href="schedule.php">Lịch Chiếu</a></li>
      </ul>
